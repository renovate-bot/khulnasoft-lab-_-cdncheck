...
var TestCases = []TestCase{
	...
	{Target: "khulnasoft-lab.io", Expected: []string{"khulnasoft-lab.io"}, Args: "-nc"},
	...
	{Target: "khulnasoft-lab.io", Expected: nil, Args: "-resp -nc", CompareFunc: func(target string, got []string) error {
		cdn := "cloudflare"
